...
class RSA_sign_verify_2048 extends Benchmark{
  const RSA_sign_verify_2048(this.name) : super('RSA 2048 - $name');
  ...
  void run(){
    ...
    final pair = kp.generateRSAkeyPair(exampleSecureRandom(),1);
