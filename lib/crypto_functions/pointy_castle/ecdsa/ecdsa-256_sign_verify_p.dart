...
class ECDSA_sign_verify_256 extends Benchmark{
  const ECDSA_sign_verify_256(this.name) : super('ECDSA 256 - $name');
  ...
  void run(){
    ...
    final pair = kp.generateKeys(exampleSecureRandom(), 2);
