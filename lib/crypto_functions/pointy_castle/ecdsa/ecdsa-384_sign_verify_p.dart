...
class ECDSA_sign_verify_384 extends Benchmark{
  const ECDSA_sign_verify_384(this.name) : super('ECDSA 384 - $name');
  ...
  void run(){
    ...
    final pair = kp.generateKeys(exampleSecureRandom(), 3);
